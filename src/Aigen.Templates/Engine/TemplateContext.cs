...
/// Todas las propiedades son accesibles en snake_case desde las plantillas.
/// Ej: {{ entity_name }}, {{ pk_type }}, {{ root_namespace }}
/// </summary>
public class TemplateContext
{
    ...
    public IEnumerable<ColumnMetadata> AuditCols   =>
        Table.Columns.Where(c => c.IsAuditField);

    // ── Helpers de tipo de tabla ─────────────────────────────────
